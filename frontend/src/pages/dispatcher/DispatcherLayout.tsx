...
import { findDispatcherGroup, findDispatcherModule } from './dispatcherModules';
...
export const DispatcherLayout: React.FC = () => {
  ...
  const activeModule = findDispatcherModule(location.pathname);
  const activeGroup = findDispatcherGroup(location.pathname);
        ...
        <main className="adm-main">
          <div className="adm-topbar">
            <div className="adm-crumbs">
              ...
              <span className="mono-label" style={{ fontSize: 9 }}>DISPATCHER</span>
            ...
            <div className="adm-topbar-actions">
              ...
              >
                {theme === 'dark' ? (
                  <Sun size={16} color="var(--green)" />
                ) : (
                  <Moon size={16} color="var(--green)" />
                )}
              </button>
