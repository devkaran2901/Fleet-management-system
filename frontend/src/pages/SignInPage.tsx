  ...
  return <main className="argo-login"><section className="argo-card">
    ...
    <section className="login-panel"><div className="form-wrap">
      ...
      <div style={{ marginTop: 16, paddingTop: 14, borderTop: '1px solid var(--line)' }}>
        <div style={{ fontSize: 10, fontWeight: 700, color: 'var(--muted)', marginBottom: 8, letterSpacing: '0.5px', textTransform: 'uppercase', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 6, marginBottom: 6 }}>
          {[
            ...
            <button
              key={acc.email}
              type="button"
              title={`Auto-fill ${acc.role} credentials (${acc.email})`}
              onClick={() => {
                setEmail(acc.email);
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.borderColor = '#3fde79';
            ...
            >
              <span style={{ fontSize: 12, flexShrink: 0 }}>{acc.icon}</span>
              <div style={{ minWidth: 0, flex: 1 }}>
                <div style={{ fontWeight: 600, fontSize: 10.5, lineHeight: 1.15, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                  {acc.role}
                </div>
                <div style={{ fontSize: 9, color: 'var(--muted)', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', marginTop: 1 }}>
                  {acc.email}
                </div>
              </div>
            </button>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 5 }}>
          {[
            ...
            >
              <span style={{ fontSize: 11, flexShrink: 0 }}>{acc.icon}</span>
              <div style={{ minWidth: 0, flex: 1 }}>
                <div style={{ fontWeight: 600, fontSize: 10, lineHeight: 1.15, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                  {acc.role}
                </div>
                <div style={{ fontSize: 8.5, color: 'var(--muted)', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', marginTop: 1 }}>
                  {acc.email}
                </div>
              </div>
            </button>
