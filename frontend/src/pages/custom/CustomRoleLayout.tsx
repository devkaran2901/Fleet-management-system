...
export const CustomRoleLayout: React.FC = () => {
  const { user } = useAuth();
        ...
        <main className="adm-main">
          <div className="adm-topbar">
            <div className="adm-crumbs">
              ...
              <span className="mono-label" style={{ fontSize: 9, color: 'var(--amber)' }}>CUSTOM ROLE</span>
              <ChevronRight size={12} />
              <span className="mono-label" style={{ fontSize: 9, color: 'var(--green)' }}>
