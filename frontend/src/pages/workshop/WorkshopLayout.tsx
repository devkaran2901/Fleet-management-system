...
import { findWorkshopGroup, findWorkshopModule } from './workshopModules';
import { ToastProvider } from '../../components/admin/ui';
import '../../styles/admin.css';

export const WorkshopLayout: React.FC = () => {
  const { user } = useAuth();
  ...
  const activeModule = findWorkshopModule(location.pathname);
  const activeGroup = findWorkshopGroup(location.pathname);
        ...
        <main className="adm-main">
          <div className="adm-topbar">
            <div className="adm-crumbs">
              ...
              <span className="mono-label" style={{ fontSize: 9 }}>WORKSHOP</span>
