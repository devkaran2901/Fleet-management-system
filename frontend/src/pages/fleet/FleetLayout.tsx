...
import { findFleetGroup, findFleetModule } from './fleetModules';
...
export const FleetLayout: React.FC = () => {
  ...
  const activeModule = findFleetModule(location.pathname);
  const activeGroup = findFleetGroup(location.pathname);
        ...
        <main className="adm-main">
          <div className="adm-topbar">
            <div className="adm-crumbs">
              ...
              <span className="mono-label" style={{ fontSize: 9 }}>FLEET</span>
